    ...
    <section className="relative w-full bg-gradient-to-b from-[#030303] via-[#07101a] to-[#07101a]">
      <div className="container-max py-24 lg:py-32 relative">
        ...
        <div className="mx-auto max-w-4xl text-center">
          <div className="inline-flex items-center justify-center w-28 h-28 rounded-full bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 shadow-lg mb-6">
            {/* premium emblem */}
            <svg
