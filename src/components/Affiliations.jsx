...
const affiliations = [
  ...
  { name: "MSME", src: "/affliations/msme-micro-small-medium-enterprises-logo-png_seeklogo-259373.png" },
  { name: "Rajasthan Technical University", src: "/affliations/Rajasthan_Technical_University_logo.jpg" },
  ...
  { name: "Certiport", src: "/affliations/certiport-logo-png_seeklogo-301744.png" },
        ...
        <div className="relative overflow-hidden py-2">
          ...
          <div className="flex items-center gap-8 md:gap-10 animate-infinite-scroll min-h-[96px] whitespace-nowrap min-w-max">
            {[...affiliations, ...affiliations].map((a, i) => (
              ...
              >
                <div className={`flex items-center justify-center transition duration-300 w-48 h-24 ${a.boxClass || ""}`}>
                  <ImageWithFallback
                    src={a.src}
                    alt={a.name}
                    className={`max-h-full max-w-full object-contain drop-shadow-sm saturate-125 contrast-125 ${a.imgClass || ""}`}
